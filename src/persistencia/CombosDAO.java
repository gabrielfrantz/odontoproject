...
public class CombosDAO {
    ...
    public void popularCombo1(String tabela, JComboBox combo) {
    ...
    public void popularCombo2(String tabela, JComboBox combo) {
        combo.removeAllItems();
        ComboItem item = new ComboItem();
        item.setCodigo(0);
        item.setDescricao("Selecione");
        ...
        public void popularCombo4(String tabela, JComboBox combo) {
        combo.removeAllItems();
        ComboItem item = new ComboItem();
        item.setCodigo(0);
        item.setDescricao("Todos");
        combo.addItem(item);
        try {
            resultado = new ConexaoBD().getConnection().createStatement().executeQuery("select * from " + tabela);
            if (resultado.isBeforeFirst()) {
    ...
    public void popularCombo3(String tabela, JComboBox combo) {
        combo.removeAllItems();
        ComboItem item = new ComboItem();
        item.setCodigo(0);
        item.setDescricao("Todos");
